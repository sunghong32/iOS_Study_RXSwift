...
class MainViewController: UIViewController {
        ...
        viewModel.cellData
            .drive(tableView.rx.items) { tv, row, data in
                switch row {
                    ...
                    case 3:
                        let cell = tv.dequeueReusableCell(withIdentifier: "DetailWriteFormCell", for: IndexPath(row: row, section: 0)) as! DetailWriteFromCell

                        cell.selectionStyle = .none
                        cell.contentInputView.text = data
                        cell.bind(viewModel.detailWriteFormCellVeiwModel)
                        return cell
                    default:
                        fatalError()
                }
    ...
    private func attribute() {
        ...
        tableView.register(DetailWriteFromCell.self, forCellReuseIdentifier: "DetailWriteFormCell")  // index row 3
    }
